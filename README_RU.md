...
Мы также создали скрипт powershell, который позволяет легко установить NotPixelBot на Windows. Пока что он был протестирован только на Windows 10, но также на Windows 11 с незначительными проблемами (возможно, у вас их не будет)
